...
## 1. The Strategy is Sacred
The **ICC Strategy** (found in `src/tradebot_sci/strategy/engine.py`) is a masterpiece of quantitative geometry. It has been perfected through blood, sweat, and thousands of simulated candles.
*   **DO NOT** rewrite the core scoring logic.
*   **DO NOT** "improve" the trend detection windows unless you have a signed letter from the User.
