...
def get_config():
    # EXACT 24H WINDOW: Jan 28 17:23 -> Jan 29 17:23 UTC
    start_date = datetime(2026, 1, 28, 17, 23, 0, tzinfo=timezone.utc)
    end_date = datetime(2026, 1, 29, 17, 23, 0, tzinfo=timezone.utc)
...
def apply_overrides():
    print("[Cartridge] Final 24H Crypto Verification (Exact Window)...")
