...
def get_config():
    # START at 18:15 UTC (right after logs start)
    # END at 16:30 UTC Today
    start_date = datetime(2026, 1, 28, 18, 15, 0, tzinfo=timezone.utc)
    end_date = datetime(2026, 1, 29, 16, 30, 0, tzinfo=timezone.utc)
    ...
    return {
        ...
        "end_date": end_date,
        "initial_capital": 221.75,
        "data_dir_name": "crypto_marathon",
        "force_market_open": True
    }

def apply_overrides():
    print("[Cartridge] Running SYNCED Backtest for the ALIVE period (Jan 28 18:15 -> Now)...")
