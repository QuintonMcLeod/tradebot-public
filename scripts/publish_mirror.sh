...
rsync -av --delete \
    ...
    --exclude='Documentation/AI_HANDOFF_*.md' \
    --exclude='Documentation/AI_CHALLENGE_*.md' \
    --exclude='Documentation/PASSING_THE_BATON.md' \
    --exclude='Documentation/APOLOGY_TO_THE_AUDITOR.md' \
    --exclude='Documentation/AUDITOR_*.md' \
    --exclude='Documentation/BACKTESTER_*.md' \
    --exclude='Documentation/*_IMPLEMENTATION_PLAN.md' \
    ...
    --exclude='Documentation/Internal/' \
