...
function initChart(intervalSeconds = 900) {
    ...
    chart = LightweightCharts.createChart(chartContainer, {
        ...
        grid: {
            vertLines: { color: 'rgba(30, 41, 59, 0.05)', style: 2 },
            horzLines: { color: 'rgba(30, 41, 59, 0.05)', style: 2 },
        },
        rightPriceScale: {
...
function setupInteractiveElements() {
    ...
    document.getElementById('btn-panic')?.addEventListener('click', (e) => {
        ...
        setPanicState(!isCurrentlyHalted);
...
function setPanicState(isStarted) {
