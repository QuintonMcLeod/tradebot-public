...
class CandlesPanel(QtWidgets.QWidget):
    ...
    def __init__(self, parent: QtWidgets.QWidget, state: Any, settings: Any) -> None:
        ...
        vlayout.setContentsMargins(0, 0, 0, 0) # [ANTIGRAVITY STYLE] Full bleed
        vlayout.setSpacing(0)
        
        # Header with slight padding
        hdr_widget = QtWidgets.QWidget()
        hdr_layout = QtWidgets.QHBoxLayout(hdr_widget)
        hdr_layout.setContentsMargins(5, 5, 5, 5) # Slight padding for controls
        ...
        vlayout.addWidget(hdr_widget)
        vlayout.addWidget(self._view, 1)
        
        # [ANTIGRAVITY STYLE] Remove chart margins
